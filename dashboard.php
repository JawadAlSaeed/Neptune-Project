<html lang="en">
	...
	<head><base href="">
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="assets/media/logos/neptune-logo.png" />
	</head>
	...
	<body id="kt_body" class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-secondary-enabled page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile">
			...
			<a href="Dashboard.php">
				<img alt="Logo" src="assets/media/logos/neptune-logo.png" class="logo-default max-h-30px" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
				...
				<div class="aside aside-left d-flex aside-fixed" id="kt_aside">
					...
					<div class="aside-primary d-flex flex-column align-items-center flex-row-auto">
						...
						<div class="aside-brand d-flex flex-column align-items-center flex-column-auto py-5 py-lg-12">
							<!--begin::Logo-->
							<a href="Dashboard.php">
								<img alt="Logo" src="assets/media/logos/neptune-logo.png" class="max-h-35px" />
							</a>
							<!--end::Logo-->
						</div>
						<!--end::Brand-->
											...
											<div class="col-xl-12">
												<div class="card card-custom bg-radial-gradient-success gutter-b card-stretch">
													...
													<div class="card-body d-flex flex-column p-0">
														<!--begin::Chart-->
														<div id="piechart" style="height: 448px"></div>                                                
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">Latest Transaction</span>
												</h3>
											</div>
											<!--end::Header-->
											<!--begin::Body-->
											<div class="card-body pt-2 pb-0">
												...
												?>
													...
													<table class="table-responsive table table-borderless table-vertical-center">
													
														<thead>
															<tr>
																<th scope="col" class="p-0" style="width: 50px"></th>
																<th scope="col" class="p-0" style="width: 630px; min-width: 150px"></th>
																<th scope="col" class="p-0" style="min-width: 70px"></th>
														...
														<tbody>
															<tr>
																...
																<td class="pl-0">
																	<a href="report.php" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg"><?php echo $category;?></a>
										...
										<div class="row"> 
												<div class="col-xl-6">
													<div class="card card-custom bg-radial-gradient-success gutter-b card-stretch">
														<!--begin::Header-->
														<div class="card-header border-0 py-5">
															<h3 class="card-title font-weight-bolder text-white"> Average Expenses </h3>
														</div>
														<!--end::Header-->
														<!--begin::Body-->
														<div class="card-body d-flex flex-column p-0">
															<!--begin::Expenses Chart-->
																<div id="ExpensesـChart" style="height: 400px;"></div>
																...
																<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
																	...
																	function drawChart() {
																		var data = google.visualization.arrayToDataTable([['Date', 'Amount'],
																<?php                                                                                                                
																...
																var options = {
																	...
																	x:{
																		...
																		var chart = new google.charts.Bar(document.getElementById('ExpensesـChart'));
											...
											<!--begin::Mixed Widget 6-->
												<div class="col-xl-6">
													<div class="card card-custom bg-radial-gradient-success gutter-b card-stretch">
														<!--begin::Header-->
														<div class="card-header border-0 py-5">
															<h3 class="card-title font-weight-bolder text-white"> Average Income </h3>
														</div>
														<!--end::Header-->
														<!--begin::Body-->
														<div class="card-body d-flex flex-column p-0">
															<!--begin::Income Chart-->
																<div id="IncomeـChart" style="height: 400px;"></div>
																...
																var options = {
																	...
																	y: {
																		...
																		var chart = new google.charts.Bar(document.getElementById('IncomeـChart'));
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://github.com/JawadAlSaeed/Neptune-Project" target="_blank" class="text-dark-75 text-hover-primary">Team Neptune</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
