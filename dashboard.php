												...
												<div class="card card-custom bg-radial-gradient-success gutter-b card-stretch">
													...
													<div class="card-body d-flex flex-column p-0">
														<!--begin::Expenses Chart-->
															<div id="ExpensesـChart" style="width: 410px; height: 300px;"></div>
										...
										<div class="row"> 
											<div class="col-xl-12">
												<div class="card card-custom bg-radial-gradient-success gutter-b card-stretch">
													...
													<div class="card-body d-flex flex-column p-0">
														<!--begin::Income Chart-->
															<div id="IncomeـChart" style="width: 415px; height: 300px;"></div>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-header border-0 pt-5">
												...
												<!-- <div class="card-toolbar">
													<ul class="nav nav-pills nav-pills-sm nav-dark-75">
														<li class="nav-item">
															<a class="nav-link py-2 px-4 active" data-toggle="tab" href="#kt_tab_pane_3_1">All</a>
														</li>
														<li class="nav-item">
															<a class="nav-link py-2 px-4" data-toggle="tab" href="#kt_tab_pane_3_2">Income</a>
														</li>
														<li class="nav-item">
															<a class="nav-link py-2 px-4 " data-toggle="tab" href="#kt_tab_pane_3_3">Expenses</a>
														</li>
													</ul>
												</div> -->
											</div>
											...
											<div class="card-body pt-2 pb-0">
												...
												<?php
													...
													$sql = "SELECT * FROM Expenses ORDER BY id DESC LIMIT 0,10";
