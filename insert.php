<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="Neptune-Project/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
		<link href="Neptune-Project/assets/plugins/custom/prismjs/prismjs.bundle.css" rel="stylesheet" type="text/css" />
		<link href="Neptune-Project/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="Neptune-Project/assets/media/logos/neptune-logo.png" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-secondary-enabled page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile">
			<!--begin::Logo-->
			<a href="Neptune-Project/index.html">
				<img alt="Logo" src="Neptune-Project/assets/media/logos/neptune-logo.png" class="logo-default max-h-30px" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
				...
				<div class="aside aside-left d-flex aside-fixed" id="kt_aside">
					...
					<div class="aside-primary d-flex flex-column align-items-center flex-row-auto">
						...
						<div class="aside-brand d-flex flex-column align-items-center flex-column-auto py-5 py-lg-12">
							<!--begin::Logo-->
							<a href="Neptune-Project/index.html">
								<img alt="Logo" src="Neptune-Project/assets/media/logos/neptune-logo.png" class="max-h-35px" />
							</a>
							<!--end::Logo-->
						</div>
						<!--end::Brand-->
						...
						<div class="aside-nav d-flex flex-column align-items-center flex-column-fluid py-5 scroll scroll-pull">
													...
													<ul class="nav flex-column" role="tablist">
														...
														<li class="nav-item mb-3" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Dashbord">
															<a href="Neptune-Project/index.html" class="nav-link btn btn-icon btn-clean btn-lg">
														...
														<li class="nav-item mb-3" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Insert">
															<a href="Neptune-Project/insert.php" class="nav-link btn btn-icon btn-clean btn-lg active">
																<span class="svg-icon svg-icon-xl">
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form action="Neptune-Project/php_send.php" method="post" class="form">
												<div class="card-body">
												...
												<input type="text" class="form-control" name="recipient" placeholder="Enter Recipient name" />
		...
		<script src="Neptune-Project/assets/plugins/global/plugins.bundle.js"></script>
		<script src="Neptune-Project/assets/plugins/custom/prismjs/prismjs.bundle.js"></script>
		<script src="Neptune-Project/assets/js/scripts.bundle.js"></script>
